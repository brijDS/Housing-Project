...
# Importing all the necessary files/libraries here
...
# displaying max columns so that there's no truncated columns in our dataframe
...
# checked null values. It looks like we do have missing values present in few of our columns. However we will check the percentage of missing information before we began treating them.
...
# The column names and the percentage of missing data are as follows: 
...
# 
# let's drop columns that have most of their values or almost of their values filled with a "null". The columns that I am going to lose are as follows: Alley : 93.408 % FireplaceQu : 47.175 % PoolQC : 99.401 % Fence : 79.709 % MiscFeature : 96.233 %
...
# Dropping out the columns with null values
...
# tried to drop duplicates however there's no change
...
# We can see that there are 3 columns with float datatype, 35 columns with integer datatype and 38 columns with object datatype in our dataset.
...
train_df.drop(["Id", "Utilities"], axis=1, inplace=True)   #removing id and utilities as id has all the unique values and utilites only has 1 unique walue
...
# creating different list for object and numeric data types
...
# Sorted the unique values column name list to see the one's with least unique values and the one's with the most in them.
...
# 
# • Data is sort of positively skewed. for feature LotArea: 
# 
# • Data is not distributed normally or in bell curve. • Data ranges from 1300 to 164660 with mean value 10484.75 
# 
# • Data is highly positively skewed and needs to be treated accordingly. for feature YearBuilt: 
# 
# • Data is not distributed normally or in bell curve. 
# 
# • Data ranges from 1875 to 2010 with mean value 1971 
# 
# • Data is sort of negatively skewed. for feature YearRemodAdd:
# 
# • Data is not distributed normally or in bell curve. 
# 
# • Data ranges from 1950 to 2010 with mean value 1985 
# 
# • Data is sort of negatively skewed. for feature MassVnrArea: 
# 
# • Data is not distributed normally or in bell curve. 
# 
...
# 
# • Data is spreaded. for feature BsmtFinSF1: 
# 
# • Data is not distributed normally or in bell curve. 
# 
...
# • Data is sort of positively skewed. 
# 
# • Data is spreaded. for feature BsmtFinSF2: 
# 
# • Data is not distributed normally or in bell curve. 
# 
...
# • Data is sort of positively skewed. 
# 
# • Data is spreaded. for feature BsmtUnfSF: 
# 
# • Data is not distributed normally or in bell curve. 
# 
...
# • Data is sort of positively skewed. 
# 
# • Data is spreaded. for feature TotalBsmtSF: 
# 
# • Data is not distributed normally or in bell curve. 
# 
...
# • Data is sort of positively skewed. 
# 
# • Data is spreaded. for feature 1stFlrSF: 
# 
# • Data is not distributed normally or in bell curve. 
# 
...
# • Data is sort of positively skewed. 
# 
# • Data is spreaded. for feature 2ndFlrSF: 
# 
# • Data is not distributed normally or in bell curve. 
# 
...
# • Data is sort of positively skewed. 
# 
# • Data is spreaded. for feature LowQualFinSF: 
# 
# • Data is not distributed normally or in bell curve. 
# 
# • Data ranges from 0 to 572 with mean value 6.38 
# 
# • Data is highly positively skewed and needs to be treated accordingly. for feature GrLivArea: 
# 
# • Data is not distributed normally or in bell curve. 
# 
...
# • Data is sort of positively skewed. 
# 
# • Data is spreaded. for feature BsmtFullBath: 
# 
# • Data is not distributed normally or in bell curve. 
# 
# • Data ranges from 0 to 3 with mean value 0.43 for feature BsmtHalfBath: 
# 
# • Data is not distributed normally or in bell curve. 
# 
# • Data ranges from 0 to 2 with mean value 0.06 
# 
# • Data is positively skewed. for feature FullBath: 
# 
# • Data is not distributed normally or in bell curve.
# 
# • Data ranges from 0 to 3 with mean value 1.56 for feature HalfBath:
# 
# • Data is not distributed normally or in bell curve. 
# 
# • Data ranges from 0 to 2 with mean value 0.39 for feature BedroomAbvGr: 
# 
# • Data is not distributed normally or in bell curve.
# 
# • Data ranges from 0 to 8 with mean value 2.88 for feature KitchenAbvGr: 
# 
# • Data is not distributed normally or in bell curve. 
# 
# • Data ranges from 0 to 3 with mean value 1.05 for feature TotRmsAbvGrd: 
# 
# • Data is not distributed normally or in bell curve. 
# 
# • Data ranges from 2 to 14 with mean value 6.54 for feature Fireplaces: 
# 
# • Data is not distributed normally or in bell curve. 
# 
# • Data ranges from 0 to 3 with mean value 0.62 for feature GarageYrBlt: 
# 
# • Data is not distributed normally or in bell curve. 
# 
# • Data ranges from 1900 to 2010 with mean value 1978 for feature GarageCars: 
# 
# • Data is not distributed normally or in bell curve. 
# 
# • Data ranges from 0 to 4 with mean value 1.78 for feature GarageArea: 
# 
# • Data is not distributed normally or in bell curve. 
# 
# • Data ranges from 0 to 1418 with mean value 776.86 for feature WoodDeckSF: 
# 
# • Data is not distributed normally or in bell curve. 
# 
# • Data ranges from 0 to 857 with mean value 96.21 
# 
# • Data is spreaded. for feature OpenPorchSF: 
# 
# • Data is not distributed normally or in bell curve. 
# 
# • Data ranges from 0 to 547 with mean value 46.56 
# 
# • Data is spreaded. for feature EnclosedPorch: 
# 
# • Data is not distributed normally or in bell curve. 
# 
# • Data ranges from 0 to 552 with mean value 23.02 for feature 3SsnPorch: 
# 
# • Data is not distributed normally or in bell curve. 
# 
# • Data ranges from 0 to 508 with mean value 3.64 for feature ScreenPorch: 
# 
# • Data is not distributed normally or in bell curve. 
# 
# • Data ranges from 0 to 480 with mean value 15.05 
# 
# • Data is positively high skewed. for feature PoolArea: 
# 
# • Data is not distributed normally or in bell curve. 
# 
# • Data ranges from 0 to 738 with mean value 345 for feature MiscVal: 
# 
# • Data is not distributed normally or in bell curve. 
# 
# • Data ranges from 0 to 15500 with mean value 47.32
# 
# • Data is positively high skewed. for feature MoSold: 
# 
# • Data is not distributed normally or in bell curve. 
# 
# • Data ranges from 1 to 12 with mean value 6.34 for feature YrSold: 
# 
# • Data is not distributed normally or in bell curve. 
# 
# • Data ranges from 2006 to 2010 with mean value 2007 for feature SalePrice: 
# 
...
# 
# • Most of the records are for Norm. for feature Condition2: 
# 
# • Most of the records are for Norm. for feature BldgType: 
# 
# • Most of the records are for 1Fam. for feature HouseStyle: 
# 
...
# 
# -> In the columns FullBath, BedroomAbvGr, Fireplaces, Garagecars, GarageArea, YrSold Median is greater than mean so the columns 
...
# -> BsmtUnfSF: Unfinished square feet of basement area-: Around 130 houses have unfinished basement of area around 100-500 sqft -> 1stFlrSF: First Floor square feet-: Around 280 houses have 1st floor square feet area between 800-1200sqft
...
# -> Bedroom: Bedrooms above grade (does NOT include basement bedrooms)-: Most houses have 3 bedrooms above ground followed by 2 and
# 4 -> Kitchen: Kitchens above grade-: Maximum houses have 1 Kitchen. very few have 
# 2 -> TotRmsAbvGrd: Total rooms above grade (does not include bathrooms)-: Around 300 houses have 6 rooms, around 200 have 5, &250 have 7. Very few have 12 & 14 rooms 
